## Nexys4 DDR constraints for top_8lane_bidir (Nexys4 DDR Rev C)
## Target top: top_8lane_bidir
...
## NOTE: this top does not use the SD port; keep these commented unless your top-level defines SD_* ports.
...
## 7-Segment Display
## Slide Switches SW[7:0]  (set the byte value to transmit)
